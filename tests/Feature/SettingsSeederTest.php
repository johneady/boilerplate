...
test('the full seed includes the demo business details', function () {
    ...
    // The demo shop's brand (ShopSeeder) is seeded ahead of the generic
    // placeholders, so its address is the one a fresh instance shows.
    expect(app(Settings::class)->string(SettingKey::BusinessEmail))->toBe('hello@skyreel.example');
});
