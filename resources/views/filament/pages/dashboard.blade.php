    ...
    >
        ...
        <x-filament::modal id="work-overview" width="4xl" sticky-footer>
            ...
            <p class="mt-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                ...
                genuinely working at an address your customers can visit: the site itself, the data behind it, the admin
                screens your team runs it from, plus the domain, the security certificate and the server. One person to
                ask, and nothing dropped between the code being finished and the site being up.
            </p>
            ...
            <section class="mt-4 rounded-xl border border-blue-200 bg-blue-50/70 p-5 dark:border-blue-900/50 dark:bg-blue-950/30">
                ...
                <p class="mt-2 text-sm leading-relaxed text-blue-900/80 dark:text-blue-200/80">
                    Not a screenshot or a case study. This panel, the secure sign-in behind it and the site it belongs
                    to are all mine, so have a proper look around. Behind the scenes there is passkey sign-in (a
                    fingerprint or face instead of a password), an extra verification step like your bank asks for, an
                    admin area for managing users, and settings your team can change themselves without calling a
                    developer. Built, hosted and kept running by me.
                </p>
            </section>
            ...
            <section class="mt-5">
                ...
                <p class="mt-2 text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
                    Pick and choose whichever of these you want. Take them all, take none, or bring your own hosting and
                    I will work with what you already have.
                </p>
            ...
            <x-slot name="footer">
                <div class="flex w-full flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <x-filament::button color="gray" x-on:click="$dispatch('close-modal', { id: 'work-overview' })">
                            Close
                        </x-filament::button>
