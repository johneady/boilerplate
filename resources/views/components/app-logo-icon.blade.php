...
@else
    {{--
        ...
        The house is drawn in white rather than knocked out of the tile: a
        knockout shows whatever sits behind the mark, which turns it black on
        the dark auth backdrop. The gradient is dark enough that a white house
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none" aria-hidden="true" {{ $attributes }}>
        ...
        />
        <path fill="#fff" d="M24 10 9 22.5h4.5V38h8v-8.5h5V38h8V22.5H39L24 10Z" />
    </svg>
@endif
